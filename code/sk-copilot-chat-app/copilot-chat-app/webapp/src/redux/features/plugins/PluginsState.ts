...
import ClothingIcon from '../../../assets/plugin-icons/clothing.png';
/*
...
export const initialState: PluginsState = {
    ...
    Clothing: {
        name: Plugins.Clothing,
        publisher: 'Clothing',
        description: 'Search and compare clothing articles.',
        enabled: false,
        authRequirements: {},
        icon: ClothingIcon,
        headerTag: AuthHeaderTags.Clothing,
    },
};
